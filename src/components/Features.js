  ...
  return (
    <>
      <section className="features">
        ...
        <div className="features__container">
          <div className="features__feature">
            <img className="features__img" src="./coming_up.png"></img>
            <h3>Simple one click navigation</h3>
          </div>
          <div className="features__feature">
            <img className="features__img" src="./menu.png"></img>
            <h3>Simple one click navigation</h3>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="features__container">
          <div className="features__feature">
            <img className="features__img" src="./new-task.png"></img>
            <h3>Add new lists in an instant</h3>
          </div>
          <div className="features__feature">
            <img className="features__img" src="./all_tasks.png"></img>
